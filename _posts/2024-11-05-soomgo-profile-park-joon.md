...
# redirect_from:
#     - self-intro/soomgo
excerpt: "2024년 11월 기준 숨고(Soomgo) 전문가 프로필 스냅샷 — 당시 수학 과외·데이터분석·코딩 레슨 이력과 리뷰 평점 5.0(32건). 현재 이력은 포트폴리오를 참고하세요."
---

**이 글은 2024년 11월 시점의 숨고 프로필 스냅샷입니다.**
현재 이력·강의 활동은 [포트폴리오](/portfolio/)와 [소개](/about/)를 봐주세요.
{: .notice--warning}
# 박준
